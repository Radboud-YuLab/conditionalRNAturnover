...
# start data 
initial_data <- readRDS(here("4_processed_data/wholeset/no_cutoff/20250618_b.g.t.s.HL_ML.input.RDS"))
...
ml_data <- initial_data[,grep("basic|genetic|hl_mean|ensembl_gene_id", x = colnames(initial_data))]
