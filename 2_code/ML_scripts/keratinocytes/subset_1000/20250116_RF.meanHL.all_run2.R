# The goal of this run is to see the performance of all used ML models on raw data (nothing transformed of the basic features) with 1000 random observations
