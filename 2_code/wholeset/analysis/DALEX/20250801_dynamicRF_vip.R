...
saveRDS(vip_rf_rmse, here("6_results/ML/w_cutoff_threshhold/dynamic_model/DALEX/20250801_dynamicRF_vip"))
...
ggsave(filename = "6_results/ML/w_cutoff_threshhold/dynamic_model/DALEX/20250801_variable.importance_globaltop10.png", height = 8, width = 6, dpi = 500)

ggplot_imp(vip_rf_rmse, top_n = 20, name_xlab = "Root mean squared error\nafter permutations")
ggsave(filename = "6_results/ML/w_cutoff_threshhold/dynamic_model/DALEX/20250801_variable.importance_globaltop20.png", height = 8, width = 6, dpi = 500)
